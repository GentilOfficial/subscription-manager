      ...
      <div className="flex flex-col h-full justify-between">
        ...
        <div>
          <p className="text-[3.5rem] sm:text-[7rem] leading-none font-extrabold tracking-tighter text-app-text dark:text-app-text-dark">
            <span className="text-primary pr-2">{site.currency}</span>{stats.totalMonthly.toFixed(0)}<span className="text-2xl sm:text-5xl text-app-text-muted/30">.{stats.totalMonthly.toFixed(2).split('.')[1]}</span>
          </p>
