...
import { landing } from '@/app/config/content';
...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 pb-12 relative overflow-hidden text-app-text dark:text-app-text-dark selection:bg-primary-muted selection:text-primary">
