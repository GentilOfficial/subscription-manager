...
import { notFound as content } from "./config/content";
...
export default function NotFound() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden text-app-text dark:text-app-text-dark">
