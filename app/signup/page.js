        ...
        <div className="relative z-10 w-full max-w-lg mb-20">
          ...
          <div className="bg-app-surface/70 dark:bg-app-surface-dark/60 backdrop-blur-3xl border border-black/5 dark:border-white/5 p-10 sm:p-12 rounded-[3.5rem] shadow-2xl animate-in fade-in duration-700">
            <div className="text-center space-y-6">
              ...
              <Link
                href="/login"
                className="w-full flex items-center justify-center gap-3 py-5 px-6 border border-brand-400/30 rounded-[2rem] text-lg font-bold tracking-wide text-white bg-primary hover:bg-primary-light transition-all shadow-lg active:scale-95"
              >
                {signup.backToLogin}
              </Link>
            </div>
